...
import { client, PRODUCT_BY_ID_QUERY } from '@/lib/sanity';
...
export default function ProductPage() {
  ...
  useEffect(() => {
    const fetchProduct = async () => {
      try {
        const productData = await client.fetch(PRODUCT_BY_ID_QUERY, { id: params.id });
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <div className="space-y-4">
            <div className="aspect-square overflow-hidden rounded-lg bg-gray-100">
              <img
                src={product.images[selectedImageIndex] ? urlFor(product.images[selectedImageIndex]).url() : ''}
                alt={product.name}
